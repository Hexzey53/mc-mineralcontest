...
public class IronVeinsPopulator_Medium extends BlockPopulator
{
	/**
	 * Générateur de charbon en couches moyennes [14;25]
	 */
	...
	{
		int X, Y, Z;
		for(int i = 1; i < 11; i++) // nombre max de filons par chunk
		{
		    if(random.nextInt(100) < 80) // probabilité de générer un filon
		    {
				...
				Y = random.nextInt(12)+1+14; // hauteur aléatoire
