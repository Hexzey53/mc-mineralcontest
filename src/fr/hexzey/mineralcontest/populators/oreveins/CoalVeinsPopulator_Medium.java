...
public class CoalVeinsPopulator_Medium extends BlockPopulator
{
	/**
	 * Générateur de charbon en couches moyennes [11;20]
	 */
	...
	public void populate(World world, Random random, Chunk chunk)
	{
		...
		for(int i = 1; i < 10; i++) // nombre max de filons par chunk
		{
		    if(random.nextInt(100) < 80) // probabilité de générer un filon
		    {
				...
				Y = random.nextInt(10)+1+10; // hauteur aléatoire
